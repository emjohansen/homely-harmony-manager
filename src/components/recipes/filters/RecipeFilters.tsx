...
export const RecipeFilters = ({
  ...
  return (
    <div className="space-y-2">
      <div className="grid grid-cols-2 gap-0 w-full max-w-lg mx-auto -mt-[1px]">
        <Button
        ...
        <Button
          ...
          className="bg-mint hover:bg-sage text-forest hover:text-cream font-dongle text-[22px] h-[36px] border border-sage rounded-l-none border-l-0"
        >
          Random Recipe
        </Button>
      </div>
