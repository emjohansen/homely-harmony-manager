  ...
  return (
    <div className="min-h-screen bg-cream pb-16">
      ...
      >
        ...
        <h1 className="relative text-5xl font-bold mb-4 text-cream uppercase tracking-wider font-averia">RECIPES</h1>
      </div>

      <div className="max-w-lg mx-auto px-4 pb-24">
        {loading ? (
          <div className="text-center py-8 text-forest font-thin">Loading recipes...</div>
        ) : (
          <Tabs 
          ...
          >
            <TabsList className="grid w-full grid-cols-2 overflow-visible bg-cream p-0 [&_[data-state=active]]:bg-sage [&_[data-state=active]]:text-cream [&_[data-state=active]]:border-sage [&_[data-state=active]]:border [&_[data-state=active]]:border-b [&_[data-state=inactive]]:bg-mint [&_[data-state=inactive]]:border-sage [&_[data-state=inactive]]:border [&_[data-state=inactive]]:border-b">
              <TabsTrigger value="private" className="text-forest font-averia text-[16px] h-[42px]">My Recipes</TabsTrigger>
              <TabsTrigger value="public" className="text-forest font-averia text-[16px] h-[42px]">All Recipes</TabsTrigger>
            </TabsList>
            <TabsContent value="private" className="w-full">
              {!currentHouseholdId ? (
                <div className="text-center py-8 text-forest font-thin">
