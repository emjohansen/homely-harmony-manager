  ...
  return (
    <div className="min-h-screen bg-cream pb-16">
      ...
      >
        ...
        <h1 className="relative text-6xl font-bold mb-4 text-cream uppercase tracking-wider font-playpen">RECIPES</h1>
      </div>
        ...
        {loading ? (
          ...
          >
            <TabsList className="grid w-full grid-cols-2 overflow-visible bg-cream p-0 [&_[data-state=active]]:bg-sage [&_[data-state=active]]:text-cream [&_[data-state=active]]:border-sage [&_[data-state=active]]:border [&_[data-state=active]]:border-b [&_[data-state=inactive]]:bg-mint [&_[data-state=inactive]]:border-sage [&_[data-state=inactive]]:border [&_[data-state=inactive]]:border-b">
              <TabsTrigger value="private" className="text-forest font-playpen text-[18px] h-[42px]">My Recipes</TabsTrigger>
              <TabsTrigger value="public" className="text-forest font-playpen text-[18px] h-[42px]">All Recipes</TabsTrigger>
            </TabsList>
      ...
      <Button
        ...
        size="icon"
      >
        <p className="font-playpen font-bold text-[120px] text-cream group-hover:text-forest leading-none flex items-center justify-center translate-x-[-1rem]">+</p>
      </Button>
