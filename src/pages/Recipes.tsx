    ...
    <div className="min-h-screen bg-cream pb-16">
      ...
      <div className="max-w-lg mx-auto px-4">
        {loading ? (
          ...
          >
            <TabsList className="grid w-full grid-cols-2 overflow-visible bg-mint p-0 [&_[data-state=active]]:bg-sage [&_[data-state=active]]:text-cream [&_[data-state=active]]:border-sage [&_[data-state=active]]:border [&_[data-state=active]]:border-b [&_[data-state=inactive]]:bg-mint [&_[data-state=inactive]]:border-sage [&_[data-state=inactive]]:border [&_[data-state=inactive]]:border-b">
