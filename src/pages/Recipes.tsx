  ...
  return (
    <div className="min-h-screen bg-cream pb-16">
      ...
      <Button
        ...
        size="icon"
      >
        <p className="font-bold text-[110px] text-cream group-hover:text-forest leading-none flex items-center justify-center translate-y-[-1.25rem] translate-x-[-1.25rem]">+</p>
      </Button>
